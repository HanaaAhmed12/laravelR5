...
<div class="container">
  <h2 style="color: #e61102;"><b>Trashed Data</b></h2>
  <table class="table table-hover">
    <thead>
      <tr>
        ...
        <th style="background-color: #f70303; color: #ffffff;">Restore</th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{{ $student->phone }}</td>
        <td>{{ $student->email }}</td>
        <td><a href="{{ route('restoreStudent' , $student->id)  }}">Reastore</a></td>
